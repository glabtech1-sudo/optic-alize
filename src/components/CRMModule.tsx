...
export const INITIAL_CUSTOMERS: Customer[] = [
  {
    id: 'OA-CL-001',
    firstName: 'Hélène',
    lastName: 'Dubois-Chambery',
    birthDate: '1974-05-12',
    email: 'helene.dubois@gmail.com',
    phone: '06 12 45 78 90',
    ssn: '2 74 05 75 010 345 67',
    ...
    prescriptions: [
      {
        id: 'pres-101',
        ophthalmologist: 'Dr. Jean-Marc Lecerf',
        odSphere: -2.50,
        odCylinder: +0.75,
        odAxis: 85,
        odAddition: 2.00,
        ...
        isExpired: true, // Over 3 years or expired according to G-LAB rules
        insuranceValidated: true
      },
      {
        id: 'pres-102',
        ophthalmologist: 'Dr. Hélène Clavel',
        odSphere: -2.75,
        odCylinder: +1.00,
        odAxis: 80,
        odAddition: 2.25,
    ...
    purchases: [
      {
        id: 'sale-2001',
        invoiceRef: 'FAC-2023-4512',
        date: '2023-02-12',
        branch: 'Paris Nation',
        amountTtc: 589.00,
        mutuelleSupport: 320.00,
        stateSupport: 50.40,
        status: 'PAID',
        opticAdvisor: 'Antoine Roussel',
        items: [
          {
            id: 'item-201',
            category: 'Monture Optique',
            name: 'Clubmaster Classic Tortoise',
            brand: 'Ray-Ban',
            qty: 1,
            unitPrice: 149.00,
            eyeSide: 'NONE',
            warrantyPolicy: 'GAR-RAYBAN-7501',
            warrantyCoverageYears: 2,
            warrantyExpired: true
          },
          {
            id: 'item-202',
            category: 'Verre Progressif',
            name: 'Varilux Physio Crizal Sapphire HR Duo',
            brand: 'Essilor',
            qty: 2,
            unitPrice: 220.00,
            eyeSide: 'BOTH',
            warrantyPolicy: 'GAR-ESSILOR-VARILUX-852',
            warrantyCoverageYears: 2,
            warrantyExpired: true
          }
        ]
      ...
      {
        id: 'sale-2002',
        invoiceRef: 'FAC-2025-0812',
        date: '2025-11-05',
        branch: 'Paris Nation',
        amountTtc: 815.00,
        mutuelleSupport: 460.00,
        stateSupport: 0.15, // French '100% Sante' class A/B division
        status: 'PAID',
        opticAdvisor: 'Sophie Kowalski',
        items: [
          {
            id: 'item-203',
            category: 'Monture Optique',
            name: 'Cat-Eye Prestige Gold Classic',
            brand: 'Chanel',
            qty: 1,
            unitPrice: 325.00,
            eyeSide: 'NONE',
            warrantyPolicy: 'GAR-CHANEL-C441A',
            warrantyCoverageYears: 2,
          ...
          },
          {
            id: 'item-204',
            category: 'Verre Progressif',
            name: 'Shamir Autograph Intelligence Advance',
            brand: 'Shamir',
            qty: 2,
            unitPrice: 245.00,
            eyeSide: 'BOTH',
            warrantyPolicy: 'GAR-SHAMIR-AUTO-941',
            warrantyCoverageYears: 2,
            warrantyExpired: false
          }
        ]
    ...
    payments: [
      { id: 'pay-501', date: '2023-02-12', amount: 218.60, method: 'CARTE BANCAIRE', reference: 'TLT-PARIS-2451920', status: 'SUCCESS' },
      { id: 'pay-502', date: '2023-02-12', amount: 320.00, method: 'TIERS_PAYANT_AMC', reference: 'MUT-ALAN-85920', status: 'SUCCESS' },
      { id: 'pay-503', date: '2023-02-12', amount: 50.40, method: 'TIERS_PAYANT_AMO', reference: 'AMO-CPAM-75-9201', status: 'SUCCESS' },
      
      { id: 'pay-504', date: '2025-11-05', amount: 354.85, method: 'CARTE BANCAIRE', reference: 'TLT-PARIS-8591024', status: 'SUCCESS', installmentIndex: '1/1' },
      { id: 'pay-505', date: '2025-11-05', amount: 460.00, method: 'TIERS_PAYANT_AMC', reference: 'MUT-MGEN-12344', status: 'SUCCESS' },
      { id: 'pay-506', date: '2025-11-05', amount: 0.15, method: 'TIERS_PAYANT_AMO', reference: 'AMO-CPAM-75-3850', status: 'SUCCESS' },
    ]
  },
  {
    id: 'OA-CL-002',
    firstName: 'Jean-Pierre',
    lastName: 'Gomez-Viguier',
    birthDate: '1961-11-20',
    email: 'jp.gomez@orange.fr',
    phone: '06 91 82 73 64',
    ssn: '1 61 11 69 002 911 25',
    registrationDate: '2024-04-10',
    loyaltyTier: 'GOLD',
    loyaltyPoints: 210,
    branch: 'Lyon Bellecour',
    prescriptions: [
      {
        id: 'pres-201',
        ophthalmologist: 'Dr. Raymond Devilliers',
        odSphere: +1.25,
        odCylinder: -0.50,
        odAxis: 45,
        odAddition: 2.50,
    ...
    purchases: [
      {
        id: 'sale-3001',
        invoiceRef: 'FAC-2024-9102',
        date: '2024-04-12',
        branch: 'Lyon Bellecour',
        amountTtc: 490.00,
        mutuelleSupport: 250.00,
        stateSupport: 12.00,
        status: 'PAID',
        opticAdvisor: 'Jérôme Martin',
        items: [
          {
            id: 'item-301',
            category: 'Monture Solaire',
            name: 'Holbrook Woodgrain polarized',
            brand: 'Oakley',
            qty: 1,
            unitPrice: 160.00,
            eyeSide: 'NONE',
            warrantyPolicy: 'GAR-OAKLEY-948',
            warrantyCoverageYears: 2,
            warrantyExpired: false
          },
          {
            id: 'item-302',
            category: 'Verre Unifocal',
            name: 'Sola Teflon Non-Reflective Thin Glass',
            brand: 'Zeiss',
            qty: 2,
            unitPrice: 165.00,
            eyeSide: 'BOTH',
            warrantyPolicy: 'GAR-ZEISS-SOLA-001',
            warrantyCoverageYears: 2,
            warrantyExpired: false
          }
        ]
    ...
    payments: [
      { id: 'pay-601', date: '2024-04-12', amount: 76.00, method: 'ESPÈCES', reference: 'ESP-LYON-5102', status: 'SUCCESS', installmentIndex: '1/3' },
      { id: 'pay-602', date: '2024-05-12', amount: 76.00, method: 'CHÈQUE', reference: 'CHQ-SG-10255', status: 'SUCCESS', installmentIndex: '2/3' },
      { id: 'pay-603', date: '2024-06-12', amount: 76.00, method: 'CHÈQUE', reference: 'CHQ-SG-10256', status: 'SUCCESS', installmentIndex: '3/3' },
      { id: 'pay-604', date: '2024-04-12', amount: 250.00, method: 'TIERS_PAYANT_AMC', reference: 'MUT-APICIL-4201', status: 'SUCCESS' },
      { id: 'pay-605', date: '2024-04-12', amount: 12.00, method: 'TIERS_PAYANT_AMO', reference: 'AMO-CPAM-69-1022', status: 'SUCCESS' },
    ]
  },
  {
    id: 'OA-CL-003',
    ...
    email: 'sarah.amri@live.fr',
    phone: '07 81 29 45 61',
    ssn: '2 89 08 13 004 591 10',
    registrationDate: '2025-05-20',
    loyaltyTier: 'STANDARD',
    loyaltyPoints: 85,
    branch: 'Marseille Vieux-Port',
    prescriptions: [
      {
        id: 'pres-301',
        ophthalmologist: 'Dr. Fatima Meziani',
        odSphere: -4.75,
        odCylinder: 0.00,
        odAxis: 0,
        odAddition: 0.00,
    ...
    purchases: [
      {
        id: 'sale-4001',
        invoiceRef: 'FAC-2025-1104',
        date: '2025-05-22',
        branch: 'Marseille Vieux-Port',
        amountTtc: 285.00,
        mutuelleSupport: 180.00,
        stateSupport: 0.00,
        status: 'PENDING',
        opticAdvisor: 'Sarah El-Amri',
        items: [
          {
            id: 'item-401',
            category: 'Monture Optique',
            name: 'Original Wayfarer Black Matte',
            brand: 'Ray-Ban',
            qty: 1,
            unitPrice: 125.00,
            eyeSide: 'NONE',
            warrantyPolicy: 'GAR-RAYBAN-1302',
            warrantyCoverageYears: 2,
            warrantyExpired: false
          },
          {
            id: 'item-402',
            category: 'Verre Unifocal',
            name: 'Essilor Ormet antireflet Blue',
            brand: 'Essilor',
            qty: 2,
            unitPrice: 80.00,
            eyeSide: 'BOTH',
            warrantyPolicy: 'GAR-ESSILOR-ORMET-902',
            warrantyCoverageYears: 2,
            warrantyExpired: false
          }
        ]
    ...
    payments: [
      { id: 'pay-701', date: '2025-05-22', amount: 105.00, method: 'CARTE BANCAIRE', reference: 'TLT-MARS-55912', status: 'PENDING' },
      { id: 'pay-702', date: '2025-05-22', amount: 180.00, method: 'TIERS_PAYANT_AMC', reference: 'MUT-ALAN-110', status: 'PENDING' }
    ]
  },
  {
    id: 'OA-CL-004',
    firstName: 'Maximilian',
    lastName: 'Vanderbilt-Roque',
    birthDate: '1982-12-01',
    email: 'maxv@roque.com',
    phone: '06 00 11 22 33',
    ssn: '1 82 12 99 333 444 55',
    registrationDate: '2024-10-02',
    loyaltyTier: 'VIP',
    loyaltyPoints: 1250,
    branch: 'Bordeaux Centre',
    prescriptions: [
      {
        id: 'pres-401',
        ophthalmologist: 'Dr. Arthur de Charette',
        odSphere: -1.00,
        odCylinder: +0.25,
        odAxis: 110,
        odAddition: 0.00,
    ...
    purchases: [
      {
        id: 'sale-5001',
        invoiceRef: 'FAC-2024-1502',
        date: '2024-10-05',
        branch: 'Bordeaux Centre',
        amountTtc: 1450.00,
        mutuelleSupport: 500.00,
        stateSupport: 0.00,
        status: 'PAID',
        opticAdvisor: 'Sophia Bordeaux Team',
        items: [
          {
            id: 'item-501',
            category: 'Monture Optique',
            name: 'Gold Signature Pilot Wireframe',
            brand: 'Cartier',
            qty: 1,
            unitPrice: 850.00,
            eyeSide: 'NONE',
            warrantyPolicy: 'GAR-CARTIER-V8104',
            warrantyCoverageYears: 3,
            warrantyExpired: false
          },
          {
            id: 'item-502',
            category: 'Verre Unifocal',
            name: 'Zeiss SmartLife single Platinum HD',
            brand: 'Zeiss',
            qty: 2,
            unitPrice: 300.00,
            eyeSide: 'BOTH',
            warrantyPolicy: 'GAR-ZEISS-VIP-859',
            warrantyCoverageYears: 3,
            warrantyExpired: false
          }
        ]
    ...
    payments: [
      { id: 'pay-801', date: '2024-10-05', amount: 950.00, method: 'CARTE BANCAIRE', reference: 'TLT-BORD-1502', status: 'SUCCESS' },
      { id: 'pay-802', date: '2024-10-05', amount: 500.00, method: 'TIERS_PAYANT_AMC', reference: 'MUT-PROBTP-9382', status: 'SUCCESS' }
    ]
  }
];
